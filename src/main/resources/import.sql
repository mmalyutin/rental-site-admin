INSERT INTO properties(id, name, geo_coordinates, feature_list, zoomlevel)
    VALUES (1,'Mastiff Crossing', ST_SetSRID((ST_MakePoint(41.652013, -70.149837)), 4326),'{Oceanview,Pool,"Exercise room",Internet/WIFI,Cable,"2 bedrooms","Sunroom w/ sleeper sofa",Washer/Dryer,"2 weeks minimum stay"}',0);
